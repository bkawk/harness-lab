...
def _llm_proposal_prompt(
    *,
    ...
    return (
        ...
        "When the live pressure is VRAM headroom, prefer paired capacity moves that can realistically increase memory use, such as science_train -> {batch_size: 3, eval_batch_size: 3} or science_model -> {hidden_dim: 160, global_dim: 256}.\n"
