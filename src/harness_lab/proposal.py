...
def _llm_proposal_prompt(
    *,
    ...
    return (
        ...
        "Good examples: science_model -> {hidden_dim: 160}; science_model -> {hidden_dim: 160, global_dim: 256}; science_train -> {batch_size: 3, eval_batch_size: 3}; science_eval -> {transfer_smoke_max_gap: 0.025}.\n"
