...
- last_heartbeat: `2026-04-02T14:09:27+00:00`
- cycles_completed: `15`
- genesis seed: `cand_0001`
- last candidate: `cand_0390`
...
## Active Backend
- active_candidate: `cand_0390`
- backend_status: `finished`
- backend_pid: `2372874`
- backend_started_at: `2026-04-02T13:59:24+00:00`
- backend_last_poll_at: `2026-04-02T14:09:27+00:00`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.361035, audit averaged 0.312607, and the mean transfer gap was 0.048427.`
- recent benchmark avg: `0.36103450431636064`
- recent audit avg: `0.3126071410209902`
- recent transfer gap avg: `0.04842736329537049`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (281 candidate(s), avg transfer gap 0.039281).`
...
- secondary_context: `Recent real-backend runs are only using about 762.0 MB on average, leaving most VRAM unused. 5 scored candidate(s) have landed since structural commit `4d32d84`.`
- scored_candidates_since_change: `5`
- last_structural_commit: `4d32d84`
### Chosen Lever Values
- source_candidate: `cand_0390`
...
### Modular Levers
- model: `science_model` (available); attempts `281`, audit_blocked `159`, avg_gap `0.03928077562706111`
- loss: `science_loss` (available); attempts `266`, audit_blocked `145`, avg_gap `0.03931423916621239`
- eval: `science_eval` (available); attempts `273`, audit_blocked `151`, avg_gap `0.039183023384330606`
- config: `science_config` (available); attempts `266`, audit_blocked `145`, avg_gap `0.03931423916621239`
- train: `science_train` (targeted); attempts `259`, audit_blocked `138`, avg_gap `0.039280324706053645`

### Recent Module Evidence
- `science_backend`: attempts `281`, audit_blocked `159`, avg_gap `0.03928077562706111`
- `science_model`: attempts `281`, audit_blocked `159`, avg_gap `0.03928077562706111`
- `science_eval`: attempts `273`, audit_blocked `151`, avg_gap `0.039183023384330606`
- `science_config`: attempts `266`, audit_blocked `145`, avg_gap `0.03931423916621239`
