...
- last_heartbeat: `2026-04-18T23:53:18+00:00`
- cycles_completed: `2080`
- genesis seed: `cand_0001`
- last candidate: `cand_2504`
...
## Active Backend
- active_candidate: `cand_2504`
- backend_status: `finished`
- backend_pid: `3126555`
- backend_started_at: `2026-04-18T23:43:13+00:00`
- backend_last_poll_at: `2026-04-18T23:53:15+00:00`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.321579, audit averaged 0.320071, and the mean transfer gap was 0.001508.`
- recent benchmark avg: `0.3215793222503345`
- recent audit avg: `0.32007131559274105`
- recent transfer gap avg: `0.0015080066575934193`
...
## Policy
- summary: `After 2503 candidates, the lab requested peer review because `dead_end_streak` fired. Current policy mode is `stabilize`.`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (2395 candidate(s), avg transfer gap 0.031893).`
...
### Modular Levers
- model: `science_model` (available); attempts `2395`, audit_blocked `1017`, avg_gap `0.03189325866006515`
- loss: `science_loss` (targeted); attempts `2380`, audit_blocked `1003`, avg_gap `0.03185262275421022`
- eval: `science_eval` (available); attempts `2387`, audit_blocked `1009`, avg_gap `0.03185809145687352`
- config: `science_config` (available); attempts `2380`, audit_blocked `1003`, avg_gap `0.03185262275421022`
- train: `science_train` (available); attempts `2373`, audit_blocked `996`, avg_gap `0.03182700105522578`

### Recent Module Evidence
- `science_backend`: attempts `2395`, audit_blocked `1017`, avg_gap `0.03189325866006515`
- `science_model`: attempts `2395`, audit_blocked `1017`, avg_gap `0.03189325866006515`
- `science_eval`: attempts `2387`, audit_blocked `1009`, avg_gap `0.03185809145687352`
- `science_config`: attempts `2380`, audit_blocked `1003`, avg_gap `0.03185262275421022`
