...
- last_heartbeat: `2026-04-01T10:09:08+00:00`
- cycles_completed: `5`
- genesis seed: `cand_0001`
- last candidate: `cand_0226`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.344218, audit averaged 0.293048, and the mean transfer gap was 0.051170.`
- recent benchmark avg: `0.34421809868701114`
- recent audit avg: `0.29304842853820146`
- recent transfer gap avg: `0.05116967014880963`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (118 candidate(s), avg transfer gap 0.039066).`
- recommended_action: `targeted_mutation`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.039066. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation.`
- secondary_context: `Recent real-backend runs are only using about 587.4 MB on average, leaving most VRAM unused. 4 scored candidate(s) have landed since structural commit `2be55f0`.`
- scored_candidates_since_change: `4`
- last_structural_commit: `2be55f0`
### Chosen Lever Values
- source_candidate: `cand_0226`
...
### Modular Levers
- model: `science_model` (targeted); attempts `118`, audit_blocked `96`, avg_gap `0.0390657383384424`
- loss: `science_loss` (available); attempts `103`, audit_blocked `82`, avg_gap `0.039118645185089645`
- eval: `science_eval` (available); attempts `110`, audit_blocked `88`, avg_gap `0.038808424264781184`
- config: `science_config` (available); attempts `103`, audit_blocked `82`, avg_gap `0.039118645185089645`
- train: `science_train` (available); attempts `96`, audit_blocked `75`, avg_gap `0.03901202328155043`

### Recent Module Evidence
- `science_backend`: attempts `118`, audit_blocked `96`, avg_gap `0.0390657383384424`
- `science_model`: attempts `118`, audit_blocked `96`, avg_gap `0.0390657383384424`
- `science_eval`: attempts `110`, audit_blocked `88`, avg_gap `0.038808424264781184`
- `science_config`: attempts `103`, audit_blocked `82`, avg_gap `0.039118645185089645`
