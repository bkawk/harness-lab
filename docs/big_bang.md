...
- last_heartbeat: `2026-04-01T01:28:35+00:00`
- cycles_completed: `19`
- genesis seed: `cand_0001`
- last candidate: `cand_0172`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.347224, audit averaged 0.290304, and the mean transfer gap was 0.056919.`
- recent benchmark avg: `0.3472238005283638`
- recent audit avg: `0.2903044713815005`
- recent transfer gap avg: `0.056919329146863276`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (65 candidate(s), avg transfer gap 0.041388).`
- recommended_action: `wait`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.041388. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation. Hold off on a mutation until the post-change sample is less thin. 0 scored candidate(s) have landed since structural commit `320fcac`.`
...
### Modular Levers
- model: `science_model` (targeted); attempts `65`, audit_blocked `57`, avg_gap `0.04138785895385057`
- loss: `science_loss` (available); attempts `50`, audit_blocked `43`, avg_gap `0.04218424247201882`
- eval: `science_eval` (available); attempts `57`, audit_blocked `49`, avg_gap `0.041257724456318576`
- config: `science_config` (available); attempts `50`, audit_blocked `43`, avg_gap `0.04218424247201882`
- train: `science_train` (available); attempts `43`, audit_blocked `36`, avg_gap `0.04249148490462211`

### Recent Module Evidence
- `science_backend`: attempts `65`, audit_blocked `57`, avg_gap `0.04138785895385057`
- `science_model`: attempts `65`, audit_blocked `57`, avg_gap `0.04138785895385057`
- `science_eval`: attempts `57`, audit_blocked `49`, avg_gap `0.041257724456318576`
- `science_config`: attempts `50`, audit_blocked `43`, avg_gap `0.04218424247201882`
