...
- last_heartbeat: `2026-04-02T19:54:31+00:00`
- cycles_completed: `46`
- genesis seed: `cand_0001`
- last candidate: `cand_0421`
...
## Active Backend
- active_candidate: `cand_0421`
- backend_status: `finished`
- backend_pid: `2384002`
- backend_started_at: `2026-04-02T19:44:28+00:00`
- backend_last_poll_at: `2026-04-02T19:54:30+00:00`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.337295, audit averaged 0.303446, and the mean transfer gap was 0.033849.`
- recent benchmark avg: `0.33729521323180006`
- recent audit avg: `0.3034464429902887`
- recent transfer gap avg: `0.033848770241511325`
...
## Policy
- summary: `After 420 candidates, the lab requested peer review because `dead_end_streak` fired. Current policy mode is `stabilize`.`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (312 candidate(s), avg transfer gap 0.037000).`
...
- secondary_context: `Recent real-backend runs are only using about 785.2 MB on average, leaving most VRAM unused. 36 scored candidate(s) have landed since structural commit `4d32d84`.`
- scored_candidates_since_change: `36`
- last_structural_commit: `4d32d84`
### Chosen Lever Values
- source_candidate: `cand_0421`
...
### Modular Levers
- model: `science_model` (available); attempts `312`, audit_blocked `170`, avg_gap `0.037000097188295854`
- loss: `science_loss` (targeted); attempts `297`, audit_blocked `156`, avg_gap `0.036910550026490414`
- eval: `science_eval` (available); attempts `304`, audit_blocked `162`, avg_gap `0.03684681535437748`
- config: `science_config` (available); attempts `297`, audit_blocked `156`, avg_gap `0.036910550026490414`
- train: `science_train` (available); attempts `290`, audit_blocked `149`, avg_gap `0.036816196962066776`

### Recent Module Evidence
- `science_backend`: attempts `312`, audit_blocked `170`, avg_gap `0.037000097188295854`
- `science_model`: attempts `312`, audit_blocked `170`, avg_gap `0.037000097188295854`
- `science_eval`: attempts `304`, audit_blocked `162`, avg_gap `0.03684681535437748`
- `science_config`: attempts `297`, audit_blocked `156`, avg_gap `0.036910550026490414`
