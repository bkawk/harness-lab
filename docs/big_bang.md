...
- last_heartbeat: `2026-04-03T14:21:00+00:00`
- cycles_completed: `97`
- genesis seed: `cand_0001`
- last candidate: `cand_0521`
...
## Active Backend
- active_candidate: `cand_0521`
- backend_status: `finished`
- backend_pid: `2655971`
- backend_started_at: `2026-04-03T14:10:58+00:00`
- backend_last_poll_at: `2026-04-03T14:21:00+00:00`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.312703, audit averaged 0.317059, and the mean transfer gap was -0.004356.`
- recent benchmark avg: `0.3127028829824914`
- recent audit avg: `0.3170586322204239`
- recent transfer gap avg: `-0.004355749237932538`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (412 candidate(s), avg transfer gap 0.034414).`
...
- secondary_context: `Recent real-backend runs are only using about 855.2 MB on average, leaving most VRAM unused. 62 scored candidate(s) have landed since structural commit `d21d25b`.`
- scored_candidates_since_change: `62`
- last_structural_commit: `d21d25b`
### Chosen Lever Values
- source_candidate: `cand_0521`
...
### Modular Levers
- model: `science_model` (available); attempts `412`, audit_blocked `205`, avg_gap `0.034414391037499166`
- loss: `science_loss` (available); attempts `397`, audit_blocked `191`, avg_gap `0.03425036235773074`
- eval: `science_eval` (available); attempts `404`, audit_blocked `197`, avg_gap `0.03424633508119888`
- config: `science_config` (available); attempts `397`, audit_blocked `191`, avg_gap `0.03425036235773074`
- train: `science_train` (targeted); attempts `390`, audit_blocked `184`, avg_gap `0.03413023051468661`

### Recent Module Evidence
- `science_backend`: attempts `412`, audit_blocked `205`, avg_gap `0.034414391037499166`
- `science_model`: attempts `412`, audit_blocked `205`, avg_gap `0.034414391037499166`
- `science_eval`: attempts `404`, audit_blocked `197`, avg_gap `0.03424633508119888`
- `science_config`: attempts `397`, audit_blocked `191`, avg_gap `0.03425036235773074`
