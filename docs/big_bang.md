...
- last_heartbeat: `2026-04-01T11:02:08+00:00`
- cycles_completed: `10`
- genesis seed: `cand_0001`
- last candidate: `cand_0231`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.319877, audit averaged 0.313451, and the mean transfer gap was 0.006426.`
- recent benchmark avg: `0.3198770699676096`
- recent audit avg: `0.31345135515504535`
- recent transfer gap avg: `0.006425714812564276`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (123 candidate(s), avg transfer gap 0.037609).`
- recommended_action: `targeted_mutation`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.037609. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation.`
- secondary_context: `Recent real-backend runs are only using about 589.9 MB on average, leaving most VRAM unused. 9 scored candidate(s) have landed since structural commit `2be55f0`.`
- scored_candidates_since_change: `9`
- last_structural_commit: `2be55f0`
### Chosen Lever Values
- source_candidate: `cand_0231`
...
### Modular Levers
- model: `science_model` (targeted); attempts `123`, audit_blocked `100`, avg_gap `0.03760859443103713`
- loss: `science_loss` (available); attempts `108`, audit_blocked `86`, avg_gap `0.03745063853343018`
- eval: `science_eval` (available); attempts `115`, audit_blocked `92`, avg_gap `0.0372515632334246`
- config: `science_config` (available); attempts `108`, audit_blocked `86`, avg_gap `0.03745063853343018`
- train: `science_train` (available); attempts `101`, audit_blocked `79`, avg_gap `0.03722156677226548`

### Recent Module Evidence
- `science_backend`: attempts `123`, audit_blocked `100`, avg_gap `0.03760859443103713`
- `science_model`: attempts `123`, audit_blocked `100`, avg_gap `0.03760859443103713`
- `science_eval`: attempts `115`, audit_blocked `92`, avg_gap `0.0372515632334246`
- `science_config`: attempts `108`, audit_blocked `86`, avg_gap `0.03745063853343018`
