...
- last_heartbeat: `2026-04-01T12:37:32+00:00`
- cycles_completed: `19`
- genesis seed: `cand_0001`
- last candidate: `cand_0240`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.311006, audit averaged 0.294793, and the mean transfer gap was 0.016213.`
- recent benchmark avg: `0.31100593965864654`
- recent audit avg: `0.2947933264036332`
- recent transfer gap avg: `0.016212613255013376`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (132 candidate(s), avg transfer gap 0.037389).`
- recommended_action: `targeted_mutation`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.037389. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation.`
- secondary_context: `Recent real-backend runs are only using about 593.5 MB on average, leaving most VRAM unused. 18 scored candidate(s) have landed since structural commit `2be55f0`.`
- scored_candidates_since_change: `18`
- last_structural_commit: `2be55f0`
### Chosen Lever Values
- source_candidate: `cand_0240`
...
### Modular Levers
- model: `science_model` (targeted); attempts `132`, audit_blocked `108`, avg_gap `0.037388621329626705`
- loss: `science_loss` (available); attempts `117`, audit_blocked `94`, avg_gap `0.037215169914811504`
- eval: `science_eval` (available); attempts `124`, audit_blocked `100`, avg_gap `0.03704445292818435`
- config: `science_config` (available); attempts `117`, audit_blocked `94`, avg_gap `0.037215169914811504`
- train: `science_train` (available); attempts `110`, audit_blocked `87`, avg_gap `0.03699023180884831`

### Recent Module Evidence
- `science_backend`: attempts `132`, audit_blocked `108`, avg_gap `0.037388621329626705`
- `science_model`: attempts `132`, audit_blocked `108`, avg_gap `0.037388621329626705`
- `science_eval`: attempts `124`, audit_blocked `100`, avg_gap `0.03704445292818435`
- `science_config`: attempts `117`, audit_blocked `94`, avg_gap `0.037215169914811504`
