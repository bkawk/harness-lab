...
- last_heartbeat: `2026-04-04T12:22:22+00:00`
- cycles_completed: `216`
- genesis seed: `cand_0001`
- last candidate: `cand_0640`
...
## Active Backend
- active_candidate: `cand_0640`
- backend_status: `finished`
- backend_pid: `2709914`
- backend_started_at: `2026-04-04T12:12:20+00:00`
- backend_last_poll_at: `2026-04-04T12:22:21+00:00`
- backend_poll_interval_seconds: `1.0`

## Recent Candidates
- `cand_0640`: outcome `dead_end`; diagnosis `complete`; benchmark `0.3320910503280755`
- `cand_0639`: outcome `dead_end`; diagnosis `complete`; benchmark `0.4194555085907012`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.367695, audit averaged 0.317776, and the mean transfer gap was 0.049919.`
- recent benchmark avg: `0.36769540640212295`
- recent audit avg: `0.31777609752172664`
- recent transfer gap avg: `0.04991930888039632`
- `cand_0640`: benchmark `0.3320910503280755`, audit `0.287904015436264`, gap `0.04418703489181153`
- `cand_0639`: benchmark `0.4194555085907012`, audit `0.3803322845378392`, gap `0.039123224052862005`
...
## Policy
- summary: `After 639 candidates, the lab requested peer review because `dead_end_streak` fired. Current policy mode is `stabilize`.`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (531 candidate(s), avg transfer gap 0.035258).`
...
- secondary_context: `Recent real-backend runs are only using about 895.9 MB on average, leaving most VRAM unused. The last structural change could not be identified, so recent-signal gating is conservative.`
- scored_candidates_since_change: `0`
- last_structural_commit: `-`
### Chosen Lever Values
- source_candidate: `cand_0640`
...
### Modular Levers
- model: `science_model` (available); attempts `531`, audit_blocked `249`, avg_gap `0.03525847475919785`
- loss: `science_loss` (targeted); attempts `516`, audit_blocked `235`, avg_gap `0.0351589246493805`
- eval: `science_eval` (available); attempts `523`, audit_blocked `241`, avg_gap `0.035144791421949026`
- config: `science_config` (available); attempts `516`, audit_blocked `235`, avg_gap `0.0351589246493805`
- train: `science_train` (available); attempts `509`, audit_blocked `228`, avg_gap `0.035081915197492534`

### Recent Module Evidence
- `science_backend`: attempts `531`, audit_blocked `249`, avg_gap `0.03525847475919785`
- `science_model`: attempts `531`, audit_blocked `249`, avg_gap `0.03525847475919785`
- `science_eval`: attempts `523`, audit_blocked `241`, avg_gap `0.035144791421949026`
- `science_config`: attempts `516`, audit_blocked `235`, avg_gap `0.0351589246493805`
