...
- last_heartbeat: `2026-04-01T13:18:18+00:00`
- cycles_completed: `1`
- genesis seed: `cand_0001`
- last candidate: `cand_0245`
...
## Science Trend
- summary: `Across the last 3 scored candidates, benchmark averaged 0.339116, audit averaged 0.280014, and the mean transfer gap was 0.059101.`
- recent benchmark avg: `0.3391157234471753`
- recent audit avg: `0.2800144437690595`
- recent transfer gap avg: `0.05910127967811577`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (137 candidate(s), avg transfer gap 0.037914).`
- recommended_action: `wait`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.037914. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation. Hold off on broad mutation until the post-change sample is less thin. Small conservative lever nudges are still allowed. 0 scored candidate(s) have landed since structural commit `15480de`.`
- secondary_context: `Recent real-backend runs are only using about 592.9 MB on average, leaving most VRAM unused. 0 scored candidate(s) have landed since structural commit `15480de`.`
- scored_candidates_since_change: `0`
- last_structural_commit: `15480de`
### Chosen Lever Values
- source_candidate: `cand_0245`
...
### Modular Levers
- model: `science_model` (targeted); attempts `137`, audit_blocked `111`, avg_gap `0.03791392757999337`
- loss: `science_loss` (available); attempts `122`, audit_blocked `97`, avg_gap `0.037812063817447075`
- eval: `science_eval` (available); attempts `129`, audit_blocked `103`, avg_gap `0.037614888102751536`
- config: `science_config` (available); attempts `122`, audit_blocked `97`, avg_gap `0.037812063817447075`
- train: `science_train` (available); attempts `115`, audit_blocked `90`, avg_gap `0.03763424291183668`

### Recent Module Evidence
- `science_backend`: attempts `137`, audit_blocked `111`, avg_gap `0.03791392757999337`
- `science_model`: attempts `137`, audit_blocked `111`, avg_gap `0.03791392757999337`
- `science_eval`: attempts `129`, audit_blocked `103`, avg_gap `0.037614888102751536`
- `science_config`: attempts `122`, audit_blocked `97`, avg_gap `0.037812063817447075`
