...
- last_heartbeat: `2026-04-01T01:17:59+00:00`
- cycles_completed: `18`
- genesis seed: `cand_0001`
- last candidate: `cand_0171`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.335417, audit averaged 0.280688, and the mean transfer gap was 0.054730.`
- recent benchmark avg: `0.3354172392747629`
- recent audit avg: `0.2806875078030786`
- recent transfer gap avg: `0.054729731471684306`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (64 candidate(s), avg transfer gap 0.040582).`
- recommended_action: `wait`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.040582. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation. Hold off on a mutation until the post-change sample is less thin. 0 scored candidate(s) have landed since structural commit `320fcac`.`
...
### Modular Levers
- model: `science_model` (targeted); attempts `64`, audit_blocked `56`, avg_gap `0.04058175666391276`
- loss: `science_loss` (available); attempts `49`, audit_blocked `42`, avg_gap `0.04115011738771231`
- eval: `science_eval` (available); attempts `56`, audit_blocked `48`, avg_gap `0.04032510384297627`
- config: `science_config` (available); attempts `49`, audit_blocked `42`, avg_gap `0.04115011738771231`
- train: `science_train` (available); attempts `42`, audit_blocked `35`, avg_gap `0.04127962563678887`

### Recent Module Evidence
- `science_backend`: attempts `64`, audit_blocked `56`, avg_gap `0.04058175666391276`
- `science_model`: attempts `64`, audit_blocked `56`, avg_gap `0.04058175666391276`
- `science_eval`: attempts `56`, audit_blocked `48`, avg_gap `0.04032510384297627`
- `science_config`: attempts `49`, audit_blocked `42`, avg_gap `0.04115011738771231`
