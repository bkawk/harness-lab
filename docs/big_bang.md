...
- last_heartbeat: `2026-04-01T04:28:48+00:00`
- cycles_completed: `36`
- genesis seed: `cand_0001`
- last candidate: `cand_0189`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.327441, audit averaged 0.293390, and the mean transfer gap was 0.034051.`
- recent benchmark avg: `0.3274406323917661`
- recent audit avg: `0.2933896920624046`
- recent transfer gap avg: `0.03405094032936147`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (82 candidate(s), avg transfer gap 0.040427).`
- recommended_action: `wait`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.040427. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation. Hold off on a mutation until the post-change sample is less thin. 0 scored candidate(s) have landed since structural commit `320fcac`.`
- secondary_context: `Recent real-backend runs are only using about 590.5 MB on average, leaving most VRAM unused. 0 scored candidate(s) have landed since structural commit `320fcac`.`
- scored_candidates_since_change: `0`
- last_structural_commit: `320fcac`
### Modular Levers
- model: `science_model` (targeted); attempts `82`, audit_blocked `70`, avg_gap `0.04042719697968382`
- loss: `science_loss` (available); attempts `67`, audit_blocked `56`, avg_gap `0.04080189631898965`
- eval: `science_eval` (available); attempts `74`, audit_blocked `62`, avg_gap `0.040218876634504824`
- config: `science_config` (available); attempts `67`, audit_blocked `56`, avg_gap `0.04080189631898965`
- train: `science_train` (available); attempts `60`, audit_blocked `49`, avg_gap `0.0408477432353568`

### Recent Module Evidence
- `science_backend`: attempts `82`, audit_blocked `70`, avg_gap `0.04042719697968382`
- `science_model`: attempts `82`, audit_blocked `70`, avg_gap `0.04042719697968382`
- `science_eval`: attempts `74`, audit_blocked `62`, avg_gap `0.040218876634504824`
- `science_config`: attempts `67`, audit_blocked `56`, avg_gap `0.04080189631898965`
