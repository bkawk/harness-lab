...
- last_heartbeat: `2026-04-01T07:14:25+00:00`
- cycles_completed: `10`
- genesis seed: `cand_0001`
- last candidate: `cand_0205`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.351620, audit averaged 0.302641, and the mean transfer gap was 0.048979.`
- recent benchmark avg: `0.3516199753182104`
- recent audit avg: `0.3026414450928109`
- recent transfer gap avg: `0.04897853022539952`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (98 candidate(s), avg transfer gap 0.039286).`
- recommended_action: `wait`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.039286. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation. Hold off on a mutation until the post-change sample is less thin. 0 scored candidate(s) have landed since structural commit `aec3acb`.`
- secondary_context: `Recent real-backend runs are only using about 595.8 MB on average, leaving most VRAM unused. 0 scored candidate(s) have landed since structural commit `aec3acb`.`
- scored_candidates_since_change: `0`
- last_structural_commit: `aec3acb`
### Chosen Lever Values
- source_candidate: `cand_0205`
- no explicit lever values chosen yet

### Modular Levers
- model: `science_model` (targeted); attempts `98`, audit_blocked `83`, avg_gap `0.03928583550395028`
- loss: `science_loss` (available); attempts `83`, audit_blocked `69`, avg_gap `0.039387122808447805`
- eval: `science_eval` (available); attempts `90`, audit_blocked `75`, avg_gap `0.03900685531608678`
- config: `science_config` (available); attempts `83`, audit_blocked `69`, avg_gap `0.039387122808447805`
- train: `science_train` (available); attempts `76`, audit_blocked `62`, avg_gap `0.03928587085926912`

### Recent Module Evidence
- `science_backend`: attempts `98`, audit_blocked `83`, avg_gap `0.03928583550395028`
- `science_model`: attempts `98`, audit_blocked `83`, avg_gap `0.03928583550395028`
- `science_eval`: attempts `90`, audit_blocked `75`, avg_gap `0.03900685531608678`
- `science_config`: attempts `83`, audit_blocked `69`, avg_gap `0.039387122808447805`
