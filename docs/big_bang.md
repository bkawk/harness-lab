...
- last_heartbeat: `2026-04-01T03:56:53+00:00`
- cycles_completed: `33`
- genesis seed: `cand_0001`
- last candidate: `cand_0186`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.325226, audit averaged 0.310037, and the mean transfer gap was 0.015190.`
- recent benchmark avg: `0.32522624987537274`
- recent audit avg: `0.3100365300760716`
- recent transfer gap avg: `0.01518971979930107`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (79 candidate(s), avg transfer gap 0.040138).`
- recommended_action: `wait`
- target_module: `science_model`
- problem: `Improve transfer-stability evaluation or smoke tests so promising candidates fail earlier before full audit.`
- why_this_module: `Recent backend edits are concentrated in `science_model` with average transfer gap 0.040138. Secondary signal: VRAM headroom is present, but it is not the main reason for this recommendation. Hold off on a mutation until the post-change sample is less thin. 0 scored candidate(s) have landed since structural commit `320fcac`.`
- secondary_context: `Recent real-backend runs are only using about 587.4 MB on average, leaving most VRAM unused. 0 scored candidate(s) have landed since structural commit `320fcac`.`
- scored_candidates_since_change: `0`
- last_structural_commit: `320fcac`
### Modular Levers
- model: `science_model` (targeted); attempts `79`, audit_blocked `67`, avg_gap `0.040138182200803806`
- loss: `science_loss` (available); attempts `64`, audit_blocked `53`, avg_gap `0.04046497811574238`
- eval: `science_eval` (available); attempts `71`, audit_blocked `59`, avg_gap `0.03988602485164605`
- config: `science_config` (available); attempts `64`, audit_blocked `53`, avg_gap `0.04046497811574238`
- train: `science_train` (available); attempts `57`, audit_blocked `46`, avg_gap `0.04046969750111639`

### Recent Module Evidence
- `science_backend`: attempts `79`, audit_blocked `67`, avg_gap `0.040138182200803806`
- `science_model`: attempts `79`, audit_blocked `67`, avg_gap `0.040138182200803806`
- `science_eval`: attempts `71`, audit_blocked `59`, avg_gap `0.03988602485164605`
- `science_config`: attempts `64`, audit_blocked `53`, avg_gap `0.04046497811574238`
