...
- last_heartbeat: `2026-04-21T07:36:55+00:00`
- cycles_completed: `2378`
- genesis seed: `cand_0001`
- last candidate: `cand_2802`
...
## Active Backend
- active_candidate: `cand_2802`
- backend_status: `finished`
- backend_pid: `3184897`
- backend_started_at: `2026-04-21T07:26:51+00:00`
- backend_last_poll_at: `2026-04-21T07:36:52+00:00`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.350889, audit averaged 0.331875, and the mean transfer gap was 0.019014.`
- recent benchmark avg: `0.35088873388316927`
- recent audit avg: `0.3318750812053435`
- recent transfer gap avg: `0.019013652677825777`
...
## Policy
- summary: `After 2801 candidates, the lab requested peer review because `dead_end_streak` fired. Current policy mode is `stabilize`.`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (2693 candidate(s), avg transfer gap 0.031389).`
...
### Modular Levers
- model: `science_model` (available); attempts `2693`, audit_blocked `1146`, avg_gap `0.03138905421539496`
- loss: `science_loss` (targeted); attempts `2678`, audit_blocked `1132`, avg_gap `0.0313503256500685`
- eval: `science_eval` (available); attempts `2685`, audit_blocked `1138`, avg_gap `0.031356315870904816`
- config: `science_config` (available); attempts `2678`, audit_blocked `1132`, avg_gap `0.0313503256500685`
- train: `science_train` (available); attempts `2671`, audit_blocked `1125`, avg_gap `0.031326263658228465`

### Recent Module Evidence
- `science_backend`: attempts `2693`, audit_blocked `1146`, avg_gap `0.03138905421539496`
- `science_model`: attempts `2693`, audit_blocked `1146`, avg_gap `0.03138905421539496`
- `science_eval`: attempts `2685`, audit_blocked `1138`, avg_gap `0.031356315870904816`
- `science_config`: attempts `2678`, audit_blocked `1132`, avg_gap `0.0313503256500685`
