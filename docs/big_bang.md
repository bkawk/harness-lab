...
- last_heartbeat: `2026-04-03T10:27:37+00:00`
- cycles_completed: `76`
- genesis seed: `cand_0001`
- last candidate: `cand_0500`
...
## Active Backend
- active_candidate: `cand_0500`
- backend_status: `finished`
- backend_pid: `2650648`
- backend_started_at: `2026-04-03T10:17:35+00:00`
- backend_last_poll_at: `2026-04-03T10:27:37+00:00`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.318268, audit averaged 0.314736, and the mean transfer gap was 0.003532.`
- recent benchmark avg: `0.31826770507604285`
- recent audit avg: `0.314736089695102`
- recent transfer gap avg: `0.0035316153809408445`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (391 candidate(s), avg transfer gap 0.034801).`
...
- secondary_context: `Recent real-backend runs are only using about 781.5 MB on average, leaving most VRAM unused. 41 scored candidate(s) have landed since structural commit `d21d25b`.`
- scored_candidates_since_change: `41`
- last_structural_commit: `d21d25b`
### Chosen Lever Values
- source_candidate: `cand_0500`
...
### Modular Levers
- model: `science_model` (available); attempts `391`, audit_blocked `200`, avg_gap `0.03480106600496871`
- loss: `science_loss` (available); attempts `376`, audit_blocked `186`, avg_gap `0.03464272763522756`
- eval: `science_eval` (available); attempts `383`, audit_blocked `192`, avg_gap `0.034631772050536185`
- config: `science_config` (available); attempts `376`, audit_blocked `186`, avg_gap `0.03464272763522756`
- train: `science_train` (targeted); attempts `369`, audit_blocked `179`, avg_gap `0.034523255934480045`

### Recent Module Evidence
- `science_backend`: attempts `391`, audit_blocked `200`, avg_gap `0.03480106600496871`
- `science_model`: attempts `391`, audit_blocked `200`, avg_gap `0.03480106600496871`
- `science_eval`: attempts `383`, audit_blocked `192`, avg_gap `0.034631772050536185`
- `science_config`: attempts `376`, audit_blocked `186`, avg_gap `0.03464272763522756`
...
- decision_reason: ``science_train` is already the active recent seam with outcomes ['dead_end', 'keeper', 'dead_end'], so keep iterating on that line rather than issuing a brand-new brief.`
- target_file: `src/harness_lab/science_train.py`
