...
- last_heartbeat: `2026-04-02T16:12:38+00:00`
- cycles_completed: `26`
- genesis seed: `cand_0001`
- last candidate: `cand_0401`
...
## Active Backend
- active_candidate: `cand_0401`
- backend_status: `finished`
- backend_pid: `2376784`
- backend_started_at: `2026-04-02T16:02:35+00:00`
- backend_last_poll_at: `2026-04-02T16:12:37+00:00`
...
## Science Trend
- summary: `Across the last 5 scored candidates, benchmark averaged 0.327006, audit averaged 0.303531, and the mean transfer gap was 0.023475.`
- recent benchmark avg: `0.3270060421064316`
- recent audit avg: `0.3035310784038684`
- recent transfer gap avg: `0.02347496370256319`
...
## Policy
- summary: `After 400 candidates, the lab requested peer review because `exhaustion_signal` fired. Current policy mode is `stabilize`.`
...
## Backend Science
- summary: `Recent backend evolution is concentrated in science_backend (292 candidate(s), avg transfer gap 0.038545).`
...
- secondary_context: `Recent real-backend runs are only using about 647.4 MB on average, leaving most VRAM unused. 16 scored candidate(s) have landed since structural commit `4d32d84`.`
- scored_candidates_since_change: `16`
- last_structural_commit: `4d32d84`
### Chosen Lever Values
- source_candidate: `cand_0401`
...
### Modular Levers
- model: `science_model` (available); attempts `292`, audit_blocked `163`, avg_gap `0.038545092101813366`
- loss: `science_loss` (targeted); attempts `277`, audit_blocked `149`, avg_gap `0.038535540849496376`
- eval: `science_eval` (available); attempts `284`, audit_blocked `155`, avg_gap `0.038428402089272055`
- config: `science_config` (available); attempts `277`, audit_blocked `149`, avg_gap `0.038535540849496376`
- train: `science_train` (available); attempts `270`, audit_blocked `142`, avg_gap `0.03848055655881785`

### Recent Module Evidence
- `science_backend`: attempts `292`, audit_blocked `163`, avg_gap `0.038545092101813366`
- `science_model`: attempts `292`, audit_blocked `163`, avg_gap `0.038545092101813366`
- `science_eval`: attempts `284`, audit_blocked `155`, avg_gap `0.038428402089272055`
- `science_config`: attempts `277`, audit_blocked `149`, avg_gap `0.038535540849496376`
