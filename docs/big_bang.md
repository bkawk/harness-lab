...
- last_heartbeat: `2026-03-31T16:09:50+00:00`
- cycles_completed: `16`
- genesis seed: `cand_0001`
- last candidate: `cand_0059`
...
## Recent Candidates
- `cand_0059`: outcome `stalled`; diagnosis `complete`; benchmark `None`
- `cand_0058`: outcome `stalled`; diagnosis `complete`; benchmark `None`
- `cand_0057`: outcome `stalled`; diagnosis `complete`; benchmark `None`
- `cand_0056`: outcome `stalled`; diagnosis `complete`; benchmark `None`
- `cand_0055`: outcome `stalled`; diagnosis `complete`; benchmark `None`
