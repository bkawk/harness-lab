...
## Secondary Context
- Recent real-backend runs are only using about 802.2 MB on average, leaving most VRAM unused. 9 scored candidate(s) have landed since structural commit `d21d25b`.
