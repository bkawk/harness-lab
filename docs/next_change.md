...
## Secondary Context
- Recent real-backend runs are only using about 718.8 MB on average, leaving most VRAM unused. 34 scored candidate(s) have landed since structural commit `4d32d84`.
