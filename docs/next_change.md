...
## Secondary Context
- Recent real-backend runs are only using about 799.4 MB on average, leaving most VRAM unused. 10 scored candidate(s) have landed since structural commit `4d32d84`.
