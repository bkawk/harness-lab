...
## Secondary Context
- Recent real-backend runs are only using about 613.2 MB on average, leaving most VRAM unused. 34 scored candidate(s) have landed since structural commit `d21d25b`.
