...
## Secondary Context
- Recent real-backend runs are only using about 742.5 MB on average, leaving most VRAM unused. 17 scored candidate(s) have landed since structural commit `7fea1af`.
