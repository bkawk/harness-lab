...
## Secondary Context
- Recent real-backend runs are only using about 782.6 MB on average, leaving most VRAM unused. 65 scored candidate(s) have landed since structural commit `d21d25b`.
