...
## Secondary Context
- Recent real-backend runs are only using about 639.6 MB on average, leaving most VRAM unused. 3 scored candidate(s) have landed since structural commit `e1cb6e3`.
