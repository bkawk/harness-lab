...
## Secondary Context
- Recent real-backend runs are only using about 679.6 MB on average, leaving most VRAM unused. 27 scored candidate(s) have landed since structural commit `d21d25b`.
