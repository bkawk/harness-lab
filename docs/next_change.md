...
## Secondary Context
- Recent real-backend runs are only using about 781.5 MB on average, leaving most VRAM unused. 41 scored candidate(s) have landed since structural commit `d21d25b`.
