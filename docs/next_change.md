...
## Secondary Context
- Recent real-backend runs are only using about 833.2 MB on average, leaving most VRAM unused. 6 scored candidate(s) have landed since structural commit `4c8bac2`.
