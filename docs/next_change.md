...
## Secondary Context
- Recent real-backend runs are only using about 682.0 MB on average, leaving most VRAM unused. 12 scored candidate(s) have landed since structural commit `4d32d84`.
