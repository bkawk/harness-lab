...
## Secondary Context
- Recent real-backend runs are only using about 685.5 MB on average, leaving most VRAM unused. 47 scored candidate(s) have landed since structural commit `49fb173`.
