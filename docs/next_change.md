...
## Secondary Context
- Recent real-backend runs are only using about 857.2 MB on average, leaving most VRAM unused. 61 scored candidate(s) have landed since structural commit `d21d25b`.
