...
## Secondary Context
- Recent real-backend runs are only using about 744.8 MB on average, leaving most VRAM unused. 21 scored candidate(s) have landed since structural commit `d21d25b`.
