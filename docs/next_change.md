...
## Secondary Context
- Recent real-backend runs are only using about 755.1 MB on average, leaving most VRAM unused. 49 scored candidate(s) have landed since structural commit `49fb173`.
