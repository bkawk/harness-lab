...
## Secondary Context
- Recent real-backend runs are only using about 685.6 MB on average, leaving most VRAM unused. 18 scored candidate(s) have landed since structural commit `4d32d84`.
