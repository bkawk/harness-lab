...
## Secondary Context
- Recent real-backend runs are only using about 710.5 MB on average, leaving most VRAM unused. 23 scored candidate(s) have landed since structural commit `d21d25b`.
