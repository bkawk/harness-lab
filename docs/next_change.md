...
## Secondary Context
- Recent real-backend runs are only using about 759.1 MB on average, leaving most VRAM unused. 32 scored candidate(s) have landed since structural commit `4d32d84`.
