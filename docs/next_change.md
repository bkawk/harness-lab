...
## Secondary Context
- Recent real-backend runs are only using about 782.0 MB on average, leaving most VRAM unused. 38 scored candidate(s) have landed since structural commit `4d32d84`.
