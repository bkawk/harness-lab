...
## Secondary Context
- Recent real-backend runs are only using about 786.2 MB on average, leaving most VRAM unused. 23 scored candidate(s) have landed since structural commit `4d32d84`.
