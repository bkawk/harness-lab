...
## Secondary Context
- Recent real-backend runs are only using about 591.1 MB on average, leaving most VRAM unused. 4 scored candidate(s) have landed since structural commit `a225c8b`.
