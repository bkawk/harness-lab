...
## Secondary Context
- Recent real-backend runs are only using about 789.5 MB on average, leaving most VRAM unused. 26 scored candidate(s) have landed since structural commit `4d32d84`.
