...
## Secondary Context
- Recent real-backend runs are only using about 790.0 MB on average, leaving most VRAM unused. 7 scored candidate(s) have landed since structural commit `49fb173`.
