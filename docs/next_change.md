...
## Secondary Context
- Recent real-backend runs are only using about 715.0 MB on average, leaving most VRAM unused. 19 scored candidate(s) have landed since structural commit `d21d25b`.
