...
## Secondary Context
- Recent real-backend runs are only using about 713.9 MB on average, leaving most VRAM unused. 73 scored candidate(s) have landed since structural commit `d21d25b`.
