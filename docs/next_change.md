...
## Secondary Context
- Recent real-backend runs are only using about 603.1 MB on average, leaving most VRAM unused. 0 scored candidate(s) have landed since structural commit `8eb05e7`.
