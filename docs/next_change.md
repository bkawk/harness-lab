...
## Secondary Context
- Recent real-backend runs are only using about 786.6 MB on average, leaving most VRAM unused. 24 scored candidate(s) have landed since structural commit `4d32d84`.
