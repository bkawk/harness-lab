...
## Secondary Context
- Recent real-backend runs are only using about 718.8 MB on average, leaving most VRAM unused. 17 scored candidate(s) have landed since structural commit `49fb173`.
