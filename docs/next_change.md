...
## Secondary Context
- Recent real-backend runs are only using about 705.0 MB on average, leaving most VRAM unused. 39 scored candidate(s) have landed since structural commit `d21d25b`.
