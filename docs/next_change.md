...
## Secondary Context
- Recent real-backend runs are only using about 869.0 MB on average, leaving most VRAM unused. 53 scored candidate(s) have landed since structural commit `d21d25b`.
