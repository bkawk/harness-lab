...
## Secondary Context
- Recent real-backend runs are only using about 785.2 MB on average, leaving most VRAM unused. 36 scored candidate(s) have landed since structural commit `4d32d84`.
