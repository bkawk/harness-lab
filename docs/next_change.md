...
## Secondary Context
- Recent real-backend runs are only using about 800.8 MB on average, leaving most VRAM unused. 8 scored candidate(s) have landed since structural commit `4d32d84`.
