...
## Secondary Context
- Recent real-backend runs are only using about 791.0 MB on average, leaving most VRAM unused. 4 scored candidate(s) have landed since structural commit `4c8bac2`.
