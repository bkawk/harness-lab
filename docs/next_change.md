...
## Secondary Context
- Recent real-backend runs are only using about 681.0 MB on average, leaving most VRAM unused. 81 scored candidate(s) have landed since structural commit `d21d25b`.
