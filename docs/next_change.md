...
## Secondary Context
- Recent real-backend runs are only using about 808.9 MB on average, leaving most VRAM unused. 63 scored candidate(s) have landed since structural commit `d21d25b`.
