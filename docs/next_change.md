...
## Secondary Context
- Recent real-backend runs are only using about 611.1 MB on average, leaving most VRAM unused. 1 scored candidate(s) have landed since structural commit `2fbef1e`.
