...
## Secondary Context
- Recent real-backend runs are only using about 647.4 MB on average, leaving most VRAM unused. 16 scored candidate(s) have landed since structural commit `4d32d84`.
