...
## Secondary Context
- Recent real-backend runs are only using about 717.4 MB on average, leaving most VRAM unused. 77 scored candidate(s) have landed since structural commit `d21d25b`.
