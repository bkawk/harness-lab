...
## Secondary Context
- Recent real-backend runs are only using about 710.9 MB on average, leaving most VRAM unused. 3 scored candidate(s) have landed since structural commit `49fb173`.
