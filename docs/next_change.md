...
## Secondary Context
- Recent real-backend runs are only using about 874.6 MB on average, leaving most VRAM unused. 38 scored candidate(s) have landed since structural commit `49fb173`.
