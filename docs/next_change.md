...
## Secondary Context
- Recent real-backend runs are only using about 831.9 MB on average, leaving most VRAM unused. 7 scored candidate(s) have landed since structural commit `4c8bac2`.
