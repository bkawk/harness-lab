...
## Secondary Context
- Recent real-backend runs are only using about 727.2 MB on average, leaving most VRAM unused. 12 scored candidate(s) have landed since structural commit `49fb173`.
