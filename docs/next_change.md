...
## Secondary Context
- Recent real-backend runs are only using about 768.6 MB on average, leaving most VRAM unused. 29 scored candidate(s) have landed since structural commit `7fea1af`.
