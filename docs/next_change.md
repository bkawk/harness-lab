...
## Secondary Context
- Recent real-backend runs are only using about 762.0 MB on average, leaving most VRAM unused. 5 scored candidate(s) have landed since structural commit `4d32d84`.
