...
## Secondary Context
- Recent real-backend runs are only using about 797.9 MB on average, leaving most VRAM unused. 23 scored candidate(s) have landed since structural commit `7fea1af`.
