...
## Secondary Context
- Recent real-backend runs are only using about 754.0 MB on average, leaving most VRAM unused. 1 scored candidate(s) have landed since structural commit `7fea1af`.
