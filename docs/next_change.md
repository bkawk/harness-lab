...
## Secondary Context
- Recent real-backend runs are only using about 600.5 MB on average, leaving most VRAM unused. 1 scored candidate(s) have landed since structural commit `e2292b1`.
