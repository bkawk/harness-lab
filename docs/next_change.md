...
## Secondary Context
- Recent real-backend runs are only using about 757.1 MB on average, leaving most VRAM unused. 5 scored candidate(s) have landed since structural commit `7fea1af`.
