...
## Secondary Context
- Recent real-backend runs are only using about 752.1 MB on average, leaving most VRAM unused. 22 scored candidate(s) have landed since structural commit `4d32d84`.
