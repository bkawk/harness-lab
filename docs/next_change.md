...
## Secondary Context
- Recent real-backend runs are only using about 949.6 MB on average, leaving most VRAM unused. 56 scored candidate(s) have landed since structural commit `d21d25b`.
