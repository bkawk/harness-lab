...
## Secondary Context
- Recent real-backend runs are only using about 683.6 MB on average, leaving most VRAM unused. 33 scored candidate(s) have landed since structural commit `49fb173`.
