...
## Secondary Context
- Recent real-backend runs are only using about 645.8 MB on average, leaving most VRAM unused. 11 scored candidate(s) have landed since structural commit `0ab69b5`.
