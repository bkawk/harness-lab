...
## Secondary Context
- Recent real-backend runs are only using about 644.5 MB on average, leaving most VRAM unused. 0 scored candidate(s) have landed since structural commit `4d32d84`.
