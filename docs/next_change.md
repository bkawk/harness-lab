...
## Secondary Context
- Recent real-backend runs are only using about 796.2 MB on average, leaving most VRAM unused. 8 scored candidate(s) have landed since structural commit `49fb173`.
