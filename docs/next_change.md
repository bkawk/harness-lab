...
## Secondary Context
- Recent real-backend runs are only using about 642.4 MB on average, leaving most VRAM unused. 2 scored candidate(s) have landed since structural commit `e1cb6e3`.
