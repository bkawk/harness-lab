...
## Secondary Context
- Recent real-backend runs are only using about 731.4 MB on average, leaving most VRAM unused. 2 scored candidate(s) have landed since structural commit `4c8bac2`.
