...
## Secondary Context
- Recent real-backend runs are only using about 721.6 MB on average, leaving most VRAM unused. 5 scored candidate(s) have landed since structural commit `49fb173`.
