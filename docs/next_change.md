...
## Secondary Context
- Recent real-backend runs are only using about 744.6 MB on average, leaving most VRAM unused. 19 scored candidate(s) have landed since structural commit `7fea1af`.
